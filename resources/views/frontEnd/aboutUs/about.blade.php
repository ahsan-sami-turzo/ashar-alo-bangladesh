      ...
      <div class="row">
        <div class="col-lg-6 left-wthree-img">
          <div class="position-relative">
            <img src="{{asset('/uploads/images/about/')}}/{{$aboutUs->image}}" alt=""
              class="img-fluid radius-image-full" height="500px" width="500px">
            <div class="bg-shape"> </div>
            <div class="imginfo__box">
              <div class="imginfo__info">
                <h6 class="imginfo__title">20+</h6>
                <p class="mt-1">Years of<br>Service</p>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-6 mt-lg-0 mt-5 about-right-faq align-self">
          <h5 class="title-small mb-1">{!!html_entity_decode( $aboutUs->small_title )!!}</h5>
          <h3 class="title-big">{{$aboutUs->big_title}}</h3>
          <h4 class="mt-4">{{$aboutUs->short_content}}</h4>
          <p class="mt-4 long_content" style="color:black; text-align: justify">{{$aboutUs->long_content}}</p>
        </div>
      </div>
    </div>
  </div>
