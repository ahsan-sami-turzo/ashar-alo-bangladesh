...
<div class="container content1">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="logoLeft">
        <img src="{{asset('uploads/images/products/')}}/{{$productlist->image_logo}}" alt="" width="168px"
          height="168px" class="logo">
  ...
  <div class="fusion-title title fusion-title-size-two" style="margin-top:0px;margin-bottom:31px;">
    <h2 class="title-heading-left" style="font-size:35px;  font-family: 'Roboto', sans-serif !important;"><b>{{$productlist->product_name}} </b></h2>
  ...
  <div class="row">
    ...
    <div class="col-md-4" style="float:right;">
      ...
      <p class="productP"><b>Projects</b></p>
      <ul class="list-group">
...
{{-- <div class="fusion-fullwidth fullwidth-box fusion-blend-mode nonhundred-percent-fullwidth"
  ...
  <div class="fusion-builder-row fusion-row ">
    <div
      class="fusion-layout-column fusion_builder_column fusion_builder_column_1_1  fusion-one-full fusion-column-first fusion-column-last 1_1"
      ...
      <div class="fusion-column-wrapper"
        ...
        data-bg-url="">
        <div class="fusion-title title fusion-title-size-two" style="margin-top:0px;margin-bottom:12px;">
          <h2 class="title-heading-left">Our Services</h2>
          <div class="title-sep-container">
            <div class="title-sep sep-double" style="border-color:#e0dede;"></div>
          </div>
        </div>
          ...
          <div class="fusion-flip-box-wrapper fusion-column col-lg-3 col-md-3 col-sm-3">
            <div class="fusion-flip-box">
              <div class="flip-box-inner-wrapper">
                <div class="flip-box-front one"
                  style="background-color:#f6f6f6;border-color:rgba(0,0,0,0);border-radius:4x;border-style:solid;border-width:1px;color:#747474;">
                  <div class="flip-box-front-inner" style="">
                    <div class="flip-box-grafix flip-box-circle"
                      style="background-color:#333333;border-color:#333333;margin-top:55px;">
                      <i class="" style="color:#ffffff;"><img
                          src="{{asset('uploads/images/products_service/')}}/{{$service->image}}" alt="5Terre"
                          height="40" width="40"></i>
                ...
                <div class="flip-box-back"
                  style="background-color:#a0ce4e;border-color:rgba(0,0,0,0);border-radius:4x;border-style:solid;border-width:1px;color:#ffffff;">
  ...
  <div class="fusion-builder-row fusion-row ">
    <div
      ...
      <div class="fusion-column-wrapper"
        ...
        data-bg-url="">
        <div class="fusion-title title fusion-title-size-two" style="margin-top:0px;margin-bottom:31px;">
          <h2 class="title-heading-left">Major Features</h2>
          <div class="title-sep-container">
            <div class="title-sep sep-double" style="border-color:#e0dede;"></div>
          </div>
        </div>
        <div class="fusion-flip-boxes flip-boxes row fusion-columns-4">
          <div class="tabs">
            ...
            <div class="tab-content" class="fusion-checklist fusion-checklist-1"
              ...
              <div id="tab{{$activeFeature->id}}" class="tab active">
                <ul class="fusion-checklist fusion-checklist-1"
                  style="font-size:13px;line-height:22.1px;padding-left: 20px;">
                  <li class="fusion-li-item">
                    <span
                      style="background-color:#52b9d8;font-size:11.44px;height:22.1px;width:22.1px;margin-right:9.1px;"
                      class="icon-wrapper circle-yes">
                      <i class="fusion-li-icon fa fa-check" style="color:#ffffff;"></i>
                    </span>
                    <div class="fusion-li-item-content" style="margin-left:31.2px;">{{$activeFeature->features_desc}}
                    </div>
                  </li>
                </ul>
              </div>
...
<div class="fusion-fullwidth fullwidth-box fusion-blend-mode nonhundred-percent-fullwidth"
  ...
  <div class="fusion-builder-row fusion-row ">
    <div
      ...
      style='margin-top:0px;margin-bottom:20px;'>
      <div class="fusion-title title fusion-title-size-two" style="margin-top:0px;margin-bottom:31px;">
        <h2 class="title-heading-left">Why Choose Us ?</p>
        </h2>
        <div class="title-sep-container">
          <div class="title-sep sep-double" style="border-color:#e0dede;"></div>
      ...
      <ul class="fusion-checklist fusion-checklist-94" style="font-size:13px;line-height:22.1px;">
        <li class="fusion-li-item">
          <span style="background-color:#a0ce4e;font-size:11.44px;height:22.1px;width:22.1px;margin-right:9.1px;"
            class="icon-wrapper circle-yes">
