...
<div class="subHeader">
  <h1 style="color:#3c7376;font-family: 'Monoton', cursive;">Features</h1>
</div>
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center"><img src="{{asset('uploads/images/services/')}}/{{$data->image}}" alt="5Terre"
                height="80px" width="100px;"></td>
            <td style="text-align: center;">
              @if($data->status == 0)
              <a onclick="return confirm('Are you sure active this post?')"
                href="{{ url('admin/activeService/'.$data->id) }}"><i class="fa fa-times" title="active"
                  style="color: red; text-align:center;"></i></a>
              @else
              <a onclick="return confirm('Are you sure Inactive this post?')"
                href="{{ url('admin/InactiveService/'.$data->id) }}"><i class="fa fa-check" title="active"
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <form id="firstSectionContents" enctype="multipart/form-data" style="background:white;margin-top:2%;"
            method="POST" action="{{ url('admin/saveService') }}">
          ...
          <form id="firstSectionContents" enctype="multipart/form-data" style="background:white;margin-top:2%;"
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-md-10">
                  <label>Short Description</label>
                  <textarea class="form-control" rows="10" name="short_description" id="short_description"
                    required></textarea>
                </div>
              </div>
            </div>
      ...
      <div class="modal-body">
        ...
        <div class="modal-footer">
          <form id="deleteForm">
            ...
            <button class="btn btn-warning glyphicon glyphicon-remove" data-dismiss="modal" type="button">
              Close</button>
          </form>
